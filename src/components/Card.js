...
export default class Card {
  constructor (element, template, handleCardClick, handleCardDelete, currentUserId, handleLike) {
    ...
    this._elementPlace = this._card.querySelector(".elements__place")
    ...
    this._likeContainer = this._card.querySelector(".elements__like-count")
  ...
  generate () {
    this._elementPlace.textContent = this._element.name
    ...
    if ( this.isLike() ) {
      this._likeElement.classList.add("element__like-button_activ")
    }
